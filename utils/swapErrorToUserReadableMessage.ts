 ...
 */
export function swapErrorToUserReadableMessage(error: any) {
  ...
  switch (reason) {
    ...
    default:
      ...
      return `Unknown error{reason ? ${reason} : ''}. Try increasing your slippage tolerance. Note: fee on transfer and rebase tokens are incompatible with Uniswap V3.`
  }
}
